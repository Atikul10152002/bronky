...
- Click on *Create a New Project* button
 ...
 .. image:: https://github.com/Atikul10152002/Bronky/blob/master/docs/img/createaproject.png?raw=true

- From the pop up list of target click on *VEX EDR* and press select button

 .. image:: https://github.com/Atikul10152002/Bronky/blob/master/docs/img/VEXEDR.png?raw=true


- Now for Language selection you can choose either *Blockly* or *Python* [Recommended] and click select

 .. image:: https://github.com/Atikul10152002/Bronky/blob/master/docs/img/languages.png?raw=true
